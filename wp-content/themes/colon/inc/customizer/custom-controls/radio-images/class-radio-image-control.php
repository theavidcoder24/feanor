...
// Exit if Colon_Radio_Image_Control exists and WP_Customize_Control does not exsist.
if ( class_exists('Colon_Radio_Image_Control') && ! class_exists( 'WP_Customize_Control' ) ) :
	return null;
endif;
 ...
 * @access public
 */
class Colon_Radio_Image_Control extends WP_Customize_Control {
	...
	public function enqueue() {
        ...
        wp_enqueue_style( 'colon-radio-image-control-css', get_parent_theme_file_uri( 'inc/customizer/custom-controls/radio-images/radio-image' . ( ( COLON_MINIFY ) ? '.min' : '' ) . '.css', array(), '1.0', 'all' ));
	}
